...
OVPlay.Player=function(){var b=function(a,c){this.options=c||{};c.source?(this.source=new c.source(a,c),c.streaming=!!this.source.streaming):a.match(/^ovplay?:\/\//)?(a=a.replace("ovplay","ws"),this.source=new OVPlay.Source.WebSocket(a,c),c.streaming=!0):(this.source=!1!==c.progressive?new OVPlay.Source.AjaxProgressive(a,c):new OVPlay.Source.Ajax(a,c),c.streaming=!1);this.maxAudioLag=c.maxAudioLag||.75;this.loop=!1!==c.loop;this.autoplay=!!c.autoplay||c.streaming;this.demuxer=new OVPlay.Demuxer.TS(c);
this.source.connect(this.demuxer);!1!==c.video&&(this.video=new OVPlay.Decoder.MPEG1Video(c),this.renderer=!c.disableGl&&OVPlay.Renderer.WebGL.IsSupported()?new OVPlay.Renderer.WebGL(c):new OVPlay.Renderer.Canvas2D(c),this.demuxer.connect(OVPlay.Demuxer.TS.STREAM.VIDEO_1,this.video),this.video.connect(this.renderer));!1!==c.audio&&OVPlay.AudioOutput.WebAudio.IsSupported()&&(this.audio=new OVPlay.Decoder.MP2Audio(c),this.audioOut=new OVPlay.AudioOutput.WebAudio(c),this.demuxer.connect(OVPlay.Demuxer.TS.STREAM.AUDIO_1,
...
this.unpauseOnShow&&this.play()};b.prototype.play=function(a){this.animationId=requestAnimationFrame(this.update.bind(this));this.wantsToPlay=!0};b.prototype.pause=function(a){cancelAnimationFrame(this.animationId);this.isPlaying=this.wantsToPlay=!1;this.audio&&this.audio.canPlay&&(this.audioOut.stop(),this.seek(this.currentTime))};b.prototype.getVolume=function(){return this.audioOut?this.audioOut.volume:0};b.prototype.setVolume=function(a){this.audioOut&&(this.audioOut.volume=a)};b.prototype.stop=
function(a){this.pause();this.seek(0);this.video&&!1!==this.options.decodeFirstFrame&&this.video.decode()};b.prototype.destroy=function(){this.pause();this.source.destroy();this.renderer.destroy();this.audioOut.destroy()};b.prototype.seek=function(a){var c=this.audio&&this.audio.canPlay?this.audio.startTime:this.video.startTime;this.video&&this.video.seek(a+c);this.audio&&this.audio.seek(a+c);this.startTime=OVPlay.Now()-a};b.prototype.getCurrentTime=function(){return this.audio&&this.audio.canPlay?
this.audio.currentTime-this.audio.startTime:this.video.currentTime-this.video.startTime};b.prototype.setCurrentTime=function(a){this.seek(a)};b.prototype.update=function(){this.animationId=requestAnimationFrame(this.update.bind(this));this.source.established?(this.isPlaying||(this.isPlaying=!0,this.startTime=OVPlay.Now()-this.currentTime),this.options.streaming?this.updateForStreaming():this.updateForStaticFile()):this.renderer&&this.renderer.renderProgress(this.source.progress)};b.prototype.updateForStreaming=
function(){this.video&&this.video.decode();if(this.audio){var a;do this.audioOut.enqueuedTime>this.maxAudioLag&&(this.audioOut.resetEnqueuedTime(),this.audioOut.enabled=!1),a=this.audio.decode();while(a);this.audioOut.enabled=!0}};b.prototype.updateForStaticFile=function(){var a=!1,c=0;if(this.audio&&this.audio.canPlay){for(;!a&&.25>this.audio.decodedTime-this.audio.currentTime;)a=!this.audio.decode();this.video&&this.video.currentTime<this.audio.currentTime&&(a=!this.video.decode());c=this.demuxer.currentTime-
this.audio.currentTime}else if(this.video){var c=OVPlay.Now()-this.startTime+this.video.startTime,e=c-this.video.currentTime,b=1/this.video.frameRate;this.video&&0<e&&(e>2*b&&(this.startTime+=e),a=!this.video.decode());c=this.demuxer.currentTime-c}this.source.resume(c);a&&this.source.completed&&(this.loop?this.seek(0):this.pause())};return b}();
OVPlay.BitBuffer=function(){var b=function(a,c){"object"===typeof a?(this.bytes=a instanceof Uint8Array?a:new Uint8Array(a),this.byteLength=this.bytes.length):(this.bytes=new Uint8Array(a||1048576),this.byteLength=0);this.mode=c||b.MODE.EXPAND;this.index=0};b.prototype.resize=function(a){var c=new Uint8Array(a);0!==this.byteLength&&(this.byteLength=Math.min(this.byteLength,a),c.set(this.bytes,0,this.byteLength));this.bytes=c;this.index=Math.min(this.index,this.byteLength<<3)};b.prototype.evict=function(a){var c=
...
OVPlay.Source.AjaxProgressive=function(){var b=function(a,c){this.url=a;this.request=this.destination=null;this.established=this.completed=!1;this.loadedSize=this.fileSize=this.progress=0;this.chunkSize=c.chunkSize||1048576;this.isLoading=!1;this.loadStartTime=0;this.throttled=!1!==c.throttled;this.aborted=!1};b.prototype.connect=function(a){this.destination=a};b.prototype.start=function(){this.request=new XMLHttpRequest;this.request.onreadystatechange=function(){this.request.readyState===this.request.DONE&&
...
1);a>=this.fileSize||this.aborted?this.completed=!0:(this.isLoading=!0,this.loadStartTime=OVPlay.Now(),this.request=new XMLHttpRequest,this.request.onreadystatechange=function(){if(this.request.readyState===this.request.DONE&&200<=this.request.status&&300>this.request.status)this.onChunkLoad(this.request.response);else this.request.readyState===this.request.DONE&&3>this.loadFails++&&this.loadNextChunk()}.bind(this),0===a&&(this.request.onprogress=this.onProgress.bind(this)),this.request.open("GET",
this.url+"?"+a+"-"+c),this.request.setRequestHeader("Range","bytes="+a+"-"+c),this.request.responseType="arraybuffer",this.request.send())};b.prototype.onProgress=function(a){this.progress=a.loaded/a.total};b.prototype.onChunkLoad=function(a){this.established=!0;this.progress=1;this.loadedSize+=a.byteLength;this.loadFails=0;this.isLoading=!1;this.destination&&this.destination.write(a);this.loadTime=OVPlay.Now()-this.loadStartTime;this.throttled||this.loadNextChunk()};return b}();
OVPlay.Source.WebSocket=function(){var b=function(a,c){this.livestream=a.substring(a.lastIndexOf("/")+1,a.length);this.url=a;this.options=c;this.socket=null;this.callbacks={connect:[],data:[]};this.destination=null;this.reconnectInterval=void 0!==c.reconnectInterval?c.reconnectInterval:5;this.shouldAttemptReconnect=!!this.reconnectInterval;this.established=this.completed=!1;this.reconnectTimeoutId=this.progress=0};b.prototype.connect=function(a){this.destination=
a};b.prototype.destroy=function(){clearTimeout(this.reconnectTimeoutId);this.shouldAttemptReconnect=!1;this.socket.close()};b.prototype.start=function(){this.shouldAttemptReconnect=!!this.reconnectInterval;this.progress=0;this.established=!1;this.socket=new WebSocket(this.url);this.socket.binaryType="arraybuffer";this.socket.onmessage=this.onMessage.bind(this);this.socket.onopen=this.onOpen.bind(this);this.socket.onerror=this.onClose.bind(this);this.socket.onclose=this.onClose.bind(this)};b.prototype.resume=
function(a){};b.prototype.onOpen=function(){this.progress=1;this.established=!0;this.socket.send("LiveStream="+this.livestream)};b.prototype.onClose=function(){this.shouldAttemptReconnect&&(clearTimeout(this.reconnectTimeoutId),this.reconnectTimeoutId=setTimeout(function(){this.start()}.bind(this),1E3*this.reconnectInterval))};b.prototype.onMessage=function(a){this.destination&&this.destination.write(a.data)};return b}();
OVPlay.Demuxer.TS=function(){var b=function(a){this.leftoverBytes=this.bits=null;this.guessVideoFrameEnd=!0;this.pidsToStreamIds={};this.pesPacketInfo={};this.currentTime=this.startTime=0};b.prototype.connect=function(a,c){this.pesPacketInfo[a]={destination:c,currentLength:0,totalLength:0,pts:0,buffers:[]}};b.prototype.write=function(a){this.leftoverBytes?(this.bits=new OVPlay.BitBuffer(a.byteLength+this.leftoverBytes.byteLength),this.bits.write([this.leftoverBytes,a])):this.bits=new OVPlay.BitBuffer(a);
...
OVPlay.Decoder.MPEG1Video=function(){var b=function(a){OVPlay.Decoder.Base.call(this,a);this.bits=new OVPlay.BitBuffer(a.videoBufferSize||524288,a.streaming?OVPlay.BitBuffer.MODE.EVICT:OVPlay.BitBuffer.MODE.EXPAND);this.customIntraQuantMatrix=new Uint8Array(64);this.customNonIntraQuantMatrix=new Uint8Array(64);this.blockData=new Int32Array(64);this.currentFrame=0;this.decodeFirstFrame=!1!==a.decodeFirstFrame};b.prototype=Object.create(OVPlay.Decoder.Base.prototype);b.prototype.constructor=b;b.prototype.write=
function(a,c){OVPlay.Decoder.Base.prototype.write.call(this,a,c);if(!this.hasSequenceHeader){if(-1===this.bits.findStartCode(b.START.SEQUENCE))return!1;this.decodeSequenceHeader();this.decodeFirstFrame&&this.decode()}};b.prototype.decode=function(){if(!this.hasSequenceHeader||-1===this.bits.findStartCode(b.START.PICTURE))return!1;this.decodePicture();this.advanceDecodedTime(1/this.frameRate);return!0};b.prototype.readHuffman=function(a){var c=0;do c=a[c+this.bits.read(1)];while(0<=c&&0!==a[c]);return a[c+
...
3));this.macroblockIntra?1===c?(b.CopyValueToDestination(this.blockData[0]+128>>8,e,d,k),this.blockData[0]=0):(b.IDCT(this.blockData),b.CopyBlockToDestination(this.blockData,e,d,k),OVPlay.Fill(this.blockData,0)):1===c?(b.AddValueToDestination(this.blockData[0]+128>>8,e,d,k),this.blockData[0]=0):(b.IDCT(this.blockData),b.AddBlockToDestination(this.blockData,e,d,k),OVPlay.Fill(this.blockData,0))};b.CopyBlockToDestination=function(a,c,b,d){for(var e=0;64>e;e+=8,b+=d+8)c[b+0]=a[e+0],c[b+1]=a[e+1],c[b+
...
OVPlay.Decoder.MP2Audio=function(){var b=function(a){OVPlay.Decoder.Base.call(this,a);this.bits=new OVPlay.BitBuffer(a.audioBufferSize||131072,a.streaming?OVPlay.BitBuffer.MODE.EVICT:OVPlay.BitBuffer.MODE.EXPAND);this.left=new Float32Array(1152);this.right=new Float32Array(1152);this.sampleRate=44100;this.D=new Float32Array(1024);this.D.set(b.SYNTHESIS_WINDOW,0);this.D.set(b.SYNTHESIS_WINDOW,512);this.V=new Float32Array(1024);this.U=new Int32Array(32);this.VPos=0;this.allocation=[Array(32),Array(32)];
this.scaleFactorInfo=[new Uint8Array(32),new Uint8Array(32)];this.scaleFactor=[Array(32),Array(32)];this.sample=[Array(32),Array(32)];for(a=0;2>a;a++)for(var c=0;32>c;c++)this.scaleFactor[a][c]=[0,0,0],this.sample[a][c]=[0,0,0]};b.prototype=Object.create(OVPlay.Decoder.Base.prototype);b.prototype.constructor=b;b.prototype.decode=function(){var a=this.bits.index>>3;if(a>=this.bits.byteLength)return!1;var c=this.decodeFrame(this.left,this.right);this.bits.index=a+c<<3;if(!c)return!1;this.destination&&
...
OVPlay.Renderer.Canvas2D=function(){var b=function(a){this.canvas=a.canvas||document.createElement("canvas");this.width=this.canvas.width;this.height=this.canvas.height;this.enabled=!0;this.context=this.canvas.getContext("2d")};b.prototype.destroy=function(){};b.prototype.resize=function(a,b){this.width=a|0;this.height=b|0;this.canvas.width=this.width;this.canvas.height=this.height;this.imageData=this.context.getImageData(0,0,this.width,this.height);OVPlay.Fill(this.imageData.data,255)};b.prototype.renderProgress=
...
this.wallclockStartTime=OVPlay.Now()),b.start(this.startTime),this.startTime+=a,this.wallclockStartTime+=a):(e=OVPlay.Now(),this.wallclockStartTime<e&&(this.wallclockStartTime=e),this.wallclockStartTime+=b.length/a))};b.prototype.stop=function(){this.gain.gain.value=0};b.prototype.getEnqueuedTime=function(){return Math.max(this.wallclockStartTime-OVPlay.Now(),0)};b.prototype.resetEnqueuedTime=function(){this.startTime=this.context.currentTime;this.wallclockStartTime=OVPlay.Now()};b.prototype.unlock=
